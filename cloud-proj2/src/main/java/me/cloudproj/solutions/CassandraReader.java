...
public class CassandraReader {
    ...
    public final static String flightLegQuery =
            "select * from storm.tom_travel where orig = ? and dest = ? and flightDate = ? and ampm = ? allow filtering";
    ...
    public void findFlightRecord(
        ...
        try {
            ...
            if(firstLegResult.isExhausted() || secondLegResult.isExhausted()) {
                ...
                System.out.println("  Sched Depart: " + secondFlightRow.get("flightTime", String.class) + " " + secondFlightDate);
